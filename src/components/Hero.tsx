        ...
        <div className="flex flex-col gap-12 md:flex-row md:items-center">
          <div className="flex-1 space-y-6 animate-fade-in">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight">
              <span className="block">Sharath</span>
              <span className="block gradient-text">Lohidakshan</span>
            </h1>

            <h2 className="text-xl md:text-2xl text-muted-foreground max-w-xl">
              Ex- Senior System Engineer • Integration Developer • DevOps Enthussiast
            </h2>

            <p className="text-muted-foreground max-w-xl">
              A passionate Software Engineer with expertise in Cloud Computing systems,
              API Integration, and Production Support.
            </p>

            <div className="flex flex-wrap gap-4 pt-4">
              <Button asChild className="group">
                <a href="Sharath L Resume.pdf" target="_blank">
