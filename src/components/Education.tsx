            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="md:order-2 md:pl-8">
                ...
                <Card className="bento-card hover-scale">
                  <h4 className="text-lg font-semibold mb-3">Lambton College, Toronto , Canada</h4>
                  <p className="text-muted-foreground">DevOps For Cloud Computing</p>
                </Card>
              </div>
            </div>
            {/* New Education Section: Post Graduate Diploma */}
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="md:text-right space-y-4 md:order-1 md:pr-8">
              ...
              <div className="md:order-2 md:pl-8">
                <div className="absolute left-0 top-1 w-2 h-2 rounded-full bg-primary md:left-1/2 md:-ml-1"></div>
                <Card className="bento-card hover-scale">
                  <h4 className="text-lg font-semibold mb-3">Anna University, India</h4>
